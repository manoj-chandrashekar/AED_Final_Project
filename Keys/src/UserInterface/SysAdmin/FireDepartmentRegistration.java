...
// Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 870, 630));
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if (isValidated()) {
            ...
            if (system.getUserAccDirectory().checkIfUsernameIsUnique(userIdTxt.getText())) {
                ...
                Fire customer = new Fire(userIdTxt.getText(), passwordTxt.getText(), locationInputField.getText(), firstNameTxt.getText(), Long.parseLong(phoneTxt.getText()));
                system.getUserAccDirectory().addAccount(customer);
                system.getFireDirectory().addFire(customer);
                populateTable();
                clearFields();
            } else {
    ...
    private void populateTable() {
        FireDirectory fireDir = system.getFireDirectory();
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();

        model.setRowCount(0);
        for (Fire f : fireDir.getFireDirectory()) {
            Object[] row = new Object[5];
            row[0] = f.getFireManName();
            row[1] = f.getFireServiceLocation();
            row[2] = f.getUsername();
            row[3] = f.getPwd();
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        if (isValidated()) {
            ...
            if (t1 >= 0) {
                ...
                FireDirectory directory = system.getFireDirectory();
                List<Fire> fireList = directory.getFireDirectory();
                ...
                for (int i = 0; i < listsize; i++) {
                    Fire c = fireList.get(i);

                    if (c.getUsername().matches(a)) {
                        c.setFireManName(firstNameTxt.getText());
                        c.setFireServiceLocation(locationInputField.getText());
    ...
    private void cancelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelButtonActionPerformed
        ...
        if (t1 >= 0) {
            String a = (String) t.getValueAt(t1, 2);
            FireDirectory bbd = system.getFireDirectory();
            List<Fire> cd1 = bbd.getFireDirectory();
            int z = cd1.size();
            for (int i = 0; i < z; i++) {
                Fire c = cd1.get(i);
                if (c.getUsername().matches(a)) {
