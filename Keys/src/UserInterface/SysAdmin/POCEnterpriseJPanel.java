...
public class POCEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.add(fireDeptPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 290, 290, 60));
        ...
        jPanel2.add(maintenancePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 290, 60));
    ...
    private void manageEmergencyEnterpriseAmbulance() {
        ...
        maintenancePanel.setBackground(new Color(255,255,255));
    ...
    private void manageEmergencyEnterprisePolice() {
        ...
        fireDeptPanel.setBackground(new Color(255,255,255));
        MaintenanceRegistration amb =new MaintenanceRegistration(system,rightSidePanel, locationPoint);
        rightSidePanel.add(amb);
        CardLayout layout = (CardLayout) rightSidePanel.getLayout();
        layout.next(rightSidePanel);
    }
