 ...
 */
public class MarketplaceEnterpriseJPanel extends javax.swing.JPanel {
    ...
    public MarketplaceEnterpriseJPanel(EcoSystem system, JPanel container) {
        initComponents();
    ...
    private void initComponents() {
        ...
        manageMarketplacePanel = new javax.swing.JPanel();
        ...
        manageMarketplacePanel.setBackground(new java.awt.Color(255, 255, 255));
        manageMarketplacePanel.setPreferredSize(new java.awt.Dimension(100, 48));
        manageMarketplacePanel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                manageMarketplacePanelMousePressed(evt);
            }
        });
        manageMarketplacePanel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Images/Icons/marketlogo.png"))); // NOI18N
        manageMarketplacePanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 30, -1));

        jLabel6.setFont(new java.awt.Font("SF Pro Text", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(115, 120, 128));
        jLabel6.setText("Manage marketplace");
        manageMarketplacePanel.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, -1, -1));

        jPanel2.add(manageMarketplacePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 290, 60));
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserInterface/Images/Icons/noun-exit-1365146.png"))); // NOI18N
    ...
    private void manageMarketplacePanelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_manageMarketplacePanelMousePressed
        // TODO add your handling code here:
        manageMarketPlace();
    }//GEN-LAST:event_manageMarketplacePanelMousePressed
    ...
    private javax.swing.JPanel manageMarketplacePanel;
    private javax.swing.JPanel rightSidePanel;
    private javax.swing.JLabel timeLabel;
    // End of variables declaration//GEN-END:variables

    private void manageMarketPlace() {
        manageMarketplacePanel.setBackground(new Color(213, 230, 249));
        MarketplaceRegisterJPanel marketplaceRegisterJPanel = new MarketplaceRegisterJPanel(system, rightSidePanel, locationPoint);
        rightSidePanel.add(marketplaceRegisterJPanel);
