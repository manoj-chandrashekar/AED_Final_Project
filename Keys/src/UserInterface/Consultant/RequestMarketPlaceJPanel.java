...
public class RequestMarketPlaceJPanel extends javax.swing.JPanel {
    ...
    public RequestMarketPlaceJPanel(JPanel userProcessContainer, EcoSystem ecosystem, UserAccount userAcc) {
        initComponents();
        this.system = ecosystem;
        this.container = userProcessContainer;
        this.userAcc = userAcc;
        displayTable();
        MarketPlaceDirectory marketPlaceDir = ecosystem.getMarketPlaceDirectory();
    ...
    private void initComponents() {
        ...
        marketPlaceList = new javax.swing.JComboBox<>();
        ...
        jLabel1.setText("Request Marketplace");
        ...
        jLabel8.setText("Consultant Name");
        units.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 220, -1));
        ...
        units.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 220, -1));
    ...
    private javax.swing.JComboBox<String> marketPlaceList;
    ...
    private void addProductRequest() {
        ...
        RequestMarketPlace reqMarket = new RequestMarketPlace();
...
//        jTable3.setModel(new DefaultTableModel(null, new String[]{"ID", "Center", "Status", "Blood Type", "Units requested"}));
    ...
    private void deleteProductRequest() {
        ...
        if (selectedRow >= 0) {
            ...
            RequestMarketPlaceDirectory reqMarketDir = system.getRequestMarketPlaceDirectory();
            List<RequestMarketPlace> reMarketList = reqMarketDir.getProductRequestList();
            int l = reMarketList.size();

            for (int i = 0; i < l; i++) {
                RequestMarketPlace reqMarket = reMarketList.get(i);
                if (sRow == reqMarket.getId()) {
                    if (reqMarket.getStatus().matches("In Progress")) {
                        reqMarket.setStatus("Cancelled");
                    } else {
